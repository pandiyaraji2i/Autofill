...
public extension UIColor {
    ...
    func getGraphLabelColor() -> UIColor{
    return UIColor(red: 158/255, green: 148/255, blue: 142/255, alpha: 1.0)
    }
    func getIndicatorGreenColor() -> UIColor{
        return UIColor(red: 157/255, green: 196/255, blue: 0/255, alpha: 1.0)
    }
    func getIndicatorGreyColor() -> UIColor{
        return UIColor(red: 222/255, green: 218/255, blue: 212/255, alpha: 1.0)
    }
    func getGridLineColor() -> UIColor{
        return  UIColor(red: 112/255, green: 122/255, blue: 122/255, alpha: 0.3)

    }
    func getLineStrokeGreen() -> UIColor{
        return  UIColor(red: 160/255, green: 200/255, blue: 0/255, alpha: 1.0)
        
    }
    func getDarkBlue() -> UIColor{
        return UIColor(red: 0/255, green: 134/255, blue: 157/255, alpha: 1.0)
    }
    func getLightBlue() -> UIColor{
        return UIColor(red: 0/255, green: 172/255, blue: 198/255, alpha: 1.0)
    }
    func getLightBlueWithAlpha() -> UIColor{
        return UIColor(red: 0/255, green: 172/255, blue: 198/255, alpha: 0.5)
    }
    
    func getLightGrey() -> UIColor{
...
public extension UIColor {
	...
	public struct social {
        ...
        public static let blueColor = UIColor(red: 58, green: 71, blue: 151)
